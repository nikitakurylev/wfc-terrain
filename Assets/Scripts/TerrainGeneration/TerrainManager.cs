...
namespace TerrainGeneration
{
    public class TerrainManager : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("terrainGenerationSettings")] [SerializeField] private TerrainGenerationSettings settings;
        ...
        public void GenerateTerrain()
        {
            ...
            for (var j = 0; j < _length; j++)
            {
                ...
                var biomeFactor = (Mathf.Lerp(biomes[biomeX, biomeY].Amplitude, biomes[biomeX + 1, biomeY].Amplitude, horizontalT) + Mathf.Lerp(biomes[biomeX, biomeY].Amplitude, biomes[biomeX, biomeY + 1].Amplitude, verticalT)) / 2;
                Debug.LogError(verticalT);
